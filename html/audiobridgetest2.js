...
server="https://mediax.sabios.com.br:8889/janus"
			...
			janus = new Janus(
				{
					...
					success: function() {
						...
						janus.attach(
							{
								plugin: "janus.plugin.audiobridge2",
								success: function(pluginHandle) {
									...
									$('#record').hide()
										.click(function() {
											mixertest.send({message: { "request": "startRecord"}});
										});
									$('#stop').hide()
										.click(function() {
											mixertest.send({message: { "request": "stopRecord"}});
										});
